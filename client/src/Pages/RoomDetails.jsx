  ...
  return room &&(
    <div className='py-28 md:py-35 px-4 md:px16 lg:px-24 xl:px-32'>
        ...
        <div className='flex item-center gap-1 text-gray-500 mt-2'>
            <img src={assets.locationIcon} alt='locatio-icone'/>
            ...
            <div className='grid grid-cols-2 gap-4 lg:w-1/2 w-full'>
                {room?.images.length > 1 && room.images.map((image,index)=>(
                    <img onClick={()=>setMainImage(image)}
                     ...
                     className={`w-full  rounded-xl shadow-md object-cover cursor-pointer ${mainImage === image && 'outline-3 outline-orange-500 gap'}`}/>
                ))}
            </div>
            {/* My E-commerce Website this method I used Plan */}
        </div>
            ...
            <div className='flex flex-col'>
                ...
                <div className='flex flex-wrap items-center mt-3 mb-6 gap-4'>
                    {room.amenities.map((item,index)=>(
                        <div key={index} className='flex itmes-center gap-2 px-3 py-2 rounded-lg bg-gray-100'>
        ...
        bg-white shadow-[0px_0px_24px_rgba(0,0,0,0.15)] p-6 rounded-xl'>
            ...
            md:items-start md:items-center gap-4 md:gap-10 text-gray-500 '>
                ...
                <div className='flex flex-col'>
                 ...
                 <div className='w-px h-15 bg-gray-300/70 max:md-hidden '></div>
                 <div className='flex flex-col'>
                    <label htmlFor='checkOutDate' className='font-medium '>checkOutDate</label>
                    <input type='date' id='checkOutDate' placeholder='guest' 
                    className='w-full rounded border border-gray-300 px-3 py-2 mt-1.5 outline-none' required/>
                </div>
            ...
            active:scal-95 transition-all text-white rounded-md max-md:w-full
        ...
        <div className='max-w-3xl border-y border-gray-300 my-15 py-10 text-gray-500'>
            <p>Guests will be allocated on the ground floor according to availability.
                ...
                ground floor acording to  availability. you get the comfortable  two bedroom apartment
        ...
        <div className='flex flex-col items-start gap-4'>
            ...
            transition-all cursor-pointer'>Conduct Now</button>
        </div>
