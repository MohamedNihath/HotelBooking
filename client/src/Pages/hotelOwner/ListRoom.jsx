...
const ListRoom = () => {
  ...
  return (
    <div>
      ...
      subTitle='Veiw, edit or manage all listed rooms. Keep the 
      information up-to-date to provite the best experience for users. '/>
                    ...
                    gap-3'>
                      ...
                      <label className='relative inline-flex items-center cursor-pointer text-gray-900 gap-3'>
                        ...
                        <div className='w-12 h-7 bg-slate-300 rounded-full peer-checked:bg-blue-600 transition-colors duration-300 relative'>
                          <div className='absolute top-1 left-1 w-5 h-5 bg-white rounded-full transition-transform duration-300 ease-in-out peer-checked:translate-x-5'></div>
                        </div>
                      </label>
