...
const DashBoard = () => {
  ...
  return (
    <div>
      <Title align='left' font='outfit' title='DashBoard' subTitle='Monito your Room Listings,
      track bookings and analyze revenue-all in one place. 
      Stay Update withreal-time insights to ensure smooth operations'/>      
      ...
      <div className='flex gap-4 my-8'>
       ...
       {/* Recent Bookings */}
       <div>
        <h2 className='text-xl text-blue-950/70 font-medium mb-5'>Recent Boookings</h2>
